...
## Contributing to Bumperbot

The following is a set of guidelines for contributing to Bumperbot project.
...
* **Which version of Bumperbot are you using?**?
* **What's the name and version of the OS you're using**?
* **Are you running Bumperbot using the provided docker container?** See [docker](docker/README.md).
* **Are you running Bumperbot in a virtual machine?** If so, which VM software are you using and which operating systems and versions are used for the host and the guest?
...
* **Perform a** [cursory search](https://github.com/AntoBrandi/Bumper-Bot/issues?q=is%3Aissue) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
* **Specify which version of Bumperbot you're using.**
...
#. **Fork the Bumperbot package** you want to contribute to. This will create
...
All Bumperbot team members actively:

* **Watch** all Bumperbot-related repositories to receive email notifications of new issues / pull requests
