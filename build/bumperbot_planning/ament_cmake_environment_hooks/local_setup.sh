...
: ${AMENT_CURRENT_PREFIX:="/home/demi/bumper_ws/install/bumperbot_planning"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bumperbot_planning/environment/library_path.sh"
